...
apply to that architecture: 35 of 40 for the hybrid point, 27 for the dense
one, 33 for the graph one. Switching the architecture changes the count and the
